...
// Make CRM_Xdedupe_ExtensionUtil available.
require_once __DIR__ . '/../../xdedupe.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('de.systopia.xdedupe');
 ...
 */
function _xdedupe_test_civicrm_container(ContainerBuilder $container): void {
}
