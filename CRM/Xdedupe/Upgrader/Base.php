 ...
 */
class CRM_Xdedupe_Upgrader_Base {

  /**
   * @var CRM_Xdedupe_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Xdedupe_Upgrader(
        'de.systopia.xdedupe',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Xdedupe_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Xdedupe_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
