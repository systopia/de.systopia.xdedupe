...
class CRM_Xdedupe_Resolver_BumpAddressConflicts extends CRM_Xdedupe_Resolver {
  ...
  /** @todo is this enough? */
  static $relevant_address_fields = ['street_address','supplemental_address_1','supplemental_address_2','supplemental_address_3','city','postal_code','location_type_id'];
  ...
  public function getHelp() {
    return E::ts("If there is conflicting addresses with the same type, the address will be changed to the (new) location type 'conflict'");
  }
