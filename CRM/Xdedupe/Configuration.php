...
class CRM_Xdedupe_Configuration {
   ...
   *   list of CRM_Xdedupe_Configuration objects
   */
  public static function getConfigurations($sql_query): array {
    $configs              = [];
   ...
   */
  public function setAttribute($attribute_name, $value, $writeTrough = FALSE): void {
    if (isset(self::$main_attributes[$attribute_name])) {
   ...
   *   true if
   */
  public static function configNameExists($name): bool {
