...
class CRM_Xdedupe_Merge {
   ...
   */
  public function multiMerge($main_contact_id, $other_contact_ids): void {
   ...
   */
  public function unloadContact($contact_id): void {
   ...
   */
  public function addMergeDetail($information): void {
   ...
   */
  public function getMergeDetails($main_contact_id): array {
   ...
   */
  public function updateMergeActivity($main_contact_id): bool {
