...
class CRM_Xdedupe_Config implements EventSubscriberInterface {
   ...
   */
  public function addBuiltinFinders(GenericHookEvent $xdedupe_list): void {
   ...
   */
  public function addBuiltinFilters(GenericHookEvent $xdedupe_list): void {
    $xdedupe_list->list = array_merge(
        $xdedupe_list->list,
        [
   ...
   */
  public function addBuiltinResolvers(GenericHookEvent $xdedupe_list): void {
    $xdedupe_list->list = array_merge(
        $xdedupe_list->list,
        [
   ...
   */
  public function addBuiltinPickers(GenericHookEvent $xdedupe_list): void {
    $xdedupe_list->list = array_merge(
        $xdedupe_list->list,
        [
   ...
   * @return int|null
   */
  public static function getMergeActivityTypeID(): ?int {
